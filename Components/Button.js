...
export default function Button({children, isLoading=false, loadingInnerHTML='Wait ...', className='', text='black', bg='white', title='Click', onClick=()=>{}, scale=300, disabled=false }) {
    return (
        <button

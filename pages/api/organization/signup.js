...
async function next(req, res){
    ...
    if(username.length < 2 || username[username.length-1] != process.env.ORGANIZATION_USERNAME_KEY) return res.json({alert: {type: 'error', msg: 'username key was invalid !!!'}, miss: false});
